with export_organisation_groupe_de_lieux_snapshot as (
    select * from  {{ ref('export_organisation_groupe_de_lieux_snapshot') }}
),
...
final as (
    ...
    from export_organisation_groupe_de_lieux_snapshot
